...
import (
	...
	"k8s.io/ingress-gce/pkg/negbinding/clientset/versioned/scheme"
)
...
// K8sV1Client is used to interact with features provided by the k8s.google.com group.
type K8sV1Client struct {
	restClient rest.Interface
}

func (c *K8sV1Client) NetworkEndpointGroupBindings(namespace string) NetworkEndpointGroupBindingInterface {
